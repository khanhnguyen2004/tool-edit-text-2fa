        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    placeholder="Nhập HTML chứa thẻ img vào đây..."
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    <textarea
                        value={result}
                        readOnly
                        placeholder="Danh sách URL ảnh sẽ hiển thị ở đây..."
            ...
            {links.length > 0 && (
                <div className="space-y-2">
                    ...
                    <div className="space-y-3 border border-[var(--border)] rounded-lg bg-white p-4">
                        {links.map((url, index) => (
                            <div key={`${url}-${index}`} className="border border-[var(--border)] rounded-lg p-3 hover:bg-[var(--muted)] transition-colors">
                                <img src={url} alt={`image-${index}`} className="max-w-full h-auto rounded mb-2" />
                                <a
                                    href={url}
                                    target="_blank"
